...
| **Putzplan** | Wiederkehrende Aufgaben mit Punkten, Intervall und optional festem Wochentag. Zuteilung wahlweise: *wer mag*, *reihum an Personen*, *reihum an Teams*, *feste Person*. Teams dürfen auch vorgemerkte Mitbewohner enthalten; beim Beitreten übernimmt die Person den Platz. Termine werden vier Wochen im Voraus geplant — Ansicht „Plan" zeigt sie nach Wochen gruppiert, „Routinen" jede angelegte Aufgabe einmal mit Rhythmus, Reihenfolge und nächstem Termin. Jede Routine kann eine Checkliste und eine Notiz haben (Vorlagen bringen passende Listen mit); beim Antippen einer Aufgabe hakt man die Punkte ab — der Bildschirm bleibt dabei an, Haken von Mitputzenden erscheinen live. Vorlagen für die häufigsten WG-Aufgaben. Abhaken ist rückgängig zu machen, Aufgaben lassen sich bearbeiten (Name, Punkte, Notiz und Checkliste ändern den Plan nicht), pausieren und löschen |
| **Teams** | Putz-Teams anlegen und Mitglieder zuordnen — Aufgaben können reihum an ganze Teams gehen |
| **Tracking** | Statistik pro Person: erledigte Aufgaben, Punkte, Pünktlichkeitsquote, offene und überfällige Zuweisungen, Vergleich zum WG-Durchschnitt. „Putzplan neu starten" setzt einen Stichtag: Punkte zählen ab dann für alle von null, Überfälliges von vorher fällt weg, im Chat steht, wer neu gestartet hat. Sobald der letzte Platzhalter übernommen ist, schlägt der Putzplan den Neustart einmal vor |
...
| **Einkauf** | Liste nach Regalreihenfolge sortiert, Kategorie wird beim Tippen geraten. Ganze Listen einfügen (z.B. Zutaten aus einem Rezept): jede Zeile wird ein Artikel, Mengen wie „500 g" oder „2x" werden erkannt, vor dem Übernehmen wählt man ab, was schon da ist. Mit dem Schloss neben dem Feld trägt man Eigenes ein, das nur man selbst sieht — in derselben Liste und im richtigen Regal; beim Abrechnen bleibt es aus der geteilten Ausgabe draußen. Vorschläge aus der WG-Historie, Dublettenerkennung, Mengen-Stepper, Realtime-Sync, Löschen mit Rückgängig. „Ich kauf ein" öffnet eine Einkaufs-Sitzung; am Ende wird daraus mit einem Betrag eine geteilte Ausgabe — ohne alles zweimal zu tippen |
...
| **Chat** | Pinnwand statt Messenger: erledigte Aufgaben, neue Ausgaben, Termine und Abwesenheiten erscheinen als Ereigniskarte im Verlauf. Aushänge kleben oben, bis man „Verstanden" getippt hat (höchstens 14 Tage; wer sie gemacht hat, kann sie abhängen); Bitten haben einen „Mach ich"-Knopf. Umfragen mit Vorlagen (Ja/Nein, nächste 7 Tage), Einfach- oder Mehrfachauswahl, Live-Ergebnis mit Namen und „fehlt noch: …"; eigene Nachrichten per langem Drücken löschen |
| **Mitteilungen** | Push bei Chat-Nachrichten, Aushängen, Bitten („Ben kümmert sich drum") und Umfragen („Alle haben abgestimmt"), neuen Ausgaben mit dem eigenen Anteil, Rückzahlungen, „Ben geht einkaufen", neuen Terminen und Abwesenheiten, neuen Mitbewohnern, wenn jemand die eigene Aufgabe übernommen hat und am Vorabend der Müllabfuhr. Erinnerung, wenn man dran ist — zur selbst gewählten Uhrzeit: morgens für heute oder abends für morgen. Jeder Bereich einzeln abschaltbar; ein Tipp öffnet den passenden Bildschirm in der richtigen WG |
...
| **Offline** | Die App startet auch ohne Netz und zeigt in allen Bereichen den zuletzt geladenen Stand, oben rechts steht dann „Offline". Die Einkaufsliste lässt sich weiter abhaken und ergänzen: Änderungen warten auf dem Handy und gehen in der richtigen Reihenfolge raus, sobald wieder Verbindung besteht. Anfragen brechen bei schlechtem Empfang nach 10 Sekunden ab, statt minutenlang zu hängen |
